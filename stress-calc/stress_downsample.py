...
x_100=np.linspace(0,Size, num=100)
y_100=np.linspace(0,Size, num=100)
z_100=np.empty((100,100), dtype=float)
for i in range(100):
    for j in range(100): 
        z_100[i,j]=interpolator(x_100[i],y_100[j]) 

interpolator2=interpolate.interp2d(x_100,y_100,z_100, kind="linear")
...
im1= ax0.pcolormesh(x,y,stress)
ax0.set_title('The Comsol stress')
...
plt.savefig('output_downsamp.png')


#Possible XDMF output for Paraview
file_results = XDMFFile("stress_calc_comrep.xdmf")
